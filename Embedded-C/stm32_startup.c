/*This file is created by Sayan Rana */

#include <stdint.h>

#define SRAM_START		0x20000000U
#define SRAM_SIZE		(128 * 1024)  //128Kbytes
...
//Prototype of 'C' std lib initialization function
...
void Reset_Handler(void)
{
	...
	/* Before calling main we have to call a function which initializes the 'C' std library. 
	(this is optional, if we use any 'C' std lib functions like printf(), scanf(), or any string manipulation functions)
	either we use semihosting or not this function calling is mandatory */
	__libc_init_array();
